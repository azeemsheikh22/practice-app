            ...
            <div className="bg-white border-b border-gray-200 px-6 py-3">
                <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        <span className="text-sm font-medium text-gray-700 mr-2">Charts:</span>
                        {Object.entries(chartDefinitions).map(([chartId, chart]) => (
                            <button
                                key={chartId}
                                onClick={() => toggleChartVisibility(chartId)}
                                className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium transition-colors cursor-pointer ${chartVisibility[chartId]
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-sm text-blue-700">
                                        Showing data for: <span className="font-medium">{selectedGroup.text}</span>
                                    </p>
                                </div>
                                <div className="text-right">
                                    <div className="text-sm text-blue-600">
                                        Active Charts: {Object.values(chartVisibility).filter(Boolean).length} / {Object.keys(chartDefinitions).length}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        {Object.keys(chartDefinitions).map((chartId) => {
                            ...
                            return (
                                <div
                                    key={chartId}
                                    className={`bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 ${!isVisible ? 'opacity-30' : ''
                                        }`}
                                    style={{
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center justify-between mb-2">
                                            <div className="flex items-center">
                                                <span className="text-lg mr-2">{chartDefinitions[chartId].icon}</span>
                                            ...
                                            {isVisible && (
                                                isInSettings ? (
                                                    <ChartSettings
                                                        ...
                                                        onSave={(settings) => handleSettingsSave(chartId, settings)}
