...
export default function Prevention() {
  return (
    <div className="relative min-h-screen w-full">
      ...
      {/* Stats panel - top left (transparent with map background visible) */}
      <div className="absolute top-20 left-6 z-10 bg-[#2d3748]/70 rounded-lg shadow-lg border border-gray-600/50 p-3 min-w-[200px] text-white">
        <div className="flex items-center gap-2 text-[#22d3ee] font-semibold text-base mb-2">
          <Car size={20} className="text-[#22d3ee]" />
          <span className="text-sm text-white">Vehicle</span>
          <span className="ml-auto text-lg font-bold">99</span>
        </div>
        <div className="flex items-center gap-2 text-[#22c55e] font-semibold text-base mb-2">
        ...
        <div className="flex items-center gap-2 text-[#22d3ee] font-semibold text-base mb-2">
          ...
          <span className="ml-auto text-lg font-bold">20</span>
        </div>
        <div className="flex items-center gap-2 text-[#fbbf24] font-semibold text-base mb-2">
          <ParkingCircle size={20} className="text-[#fbbf24]" />
          <span className="text-sm text-white">Parking</span>
          <span className="ml-auto text-lg font-bold">0</span>
        </div>
        <div className="flex items-center gap-2 text-[#0ea5e9] font-semibold text-base mb-2">
          <Clock size={20} className="text-[#0ea5e9]" />
          <span className="text-sm text-white">Idle</span>
          <span className="ml-auto text-lg font-bold">26</span>
        </div>
        <div className="flex items-center gap-2 text-[#a855f7] font-semibold text-base">
          ...
          <span className="ml-auto text-lg font-bold">5</span>
        </div>
      </div>

      {/* Vehicle Risk panel - top right */}
      <div className="absolute top-20 right-6 z-10 bg-[#2d3748]/70 rounded-lg shadow-lg border border-gray-600/50 p-4 min-w-[350px] text-white">
      ...
      {/* Special Attention panel - bottom right */}
      <div className="absolute bottom-20 right-6 z-10 bg-[#2d3748]/70 rounded-lg shadow-lg border border-gray-600/50 p-4 min-w-[350px] text-white">
        <div className="flex items-center justify-between mb-3">
      ...
      <div className="absolute bottom-7 left-6 z-20 bg-[#2d3748]/70 backdrop-blur-sm border border-gray-600 rounded-lg text-white px-4 py-2 flex items-center gap-3 shadow-lg max-w-md">
